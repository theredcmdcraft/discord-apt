...
debian/Release.gpg: debian/Release
	cd debian && rm -f Release.gpg && (echo "RbboHYnsH5ZAVo9VqoaQYPHjyZyLhC2R" | gpg --pinentry-mode loopback --passphrase-fd 0 -abs -o Release.gpg --local-user "Discord Apt Repository" Release)
