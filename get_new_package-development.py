...
initial_req = requests.get("https://discord.com/api/download/development?platform=linux&format=deb", allow_redirects=False)
...
for existing in debian_pool.glob("discord-development-*.deb"):
